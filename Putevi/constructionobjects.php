...
<head>
    ...
    <title>Строящиеся объекты</title>
...
<body>
    <div class="wrapper">
        <!-- Фоновое изображение -->
        <div class="hero-bg">
            <img src="/img/constructionobjects.jpg" alt="">
        </div>
        ...
        <?php 
            ...
            foreach ($projects as $project): 
                // Пропускаем проекты с датой окончания меньше текущей даты
        ...
        <div class="project-container">
            ...
            <div class="project-details">
                <div class="detail-item">
                    <div class="detail-label">Планируемая дата начала</div>
                    <div>
                ...
                <div class="detail-item">
                    <div class="detail-label">Планируемая дата завершения</div>
                    <div>
